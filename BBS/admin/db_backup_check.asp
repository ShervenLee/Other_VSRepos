		...
		case "db_clear"
			...
			Set objfso = server.createobject("scripting.filesystemobject")
				if chk_num(err)<>0 then
					err.clear
					call dperror(true,"不能建立fso对象，请确保你的空间支持fso","db_backup.asp")
				end if
			...
			call dperror(true,dis_html,"db_backup.asp")
	end select
