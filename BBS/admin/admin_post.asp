...
<% if rs.eof then%>
  ...
  select case topic_state
	  case 1
		...
		hy_do=hy_do&" <a class=""btn btn-success"" href=""admin_post_check.asp?mydo=checked&modid="& topic_id &""" onClick=""return makesure('是否审核该帖子?');"" title=审核>审核</a>"				 
	  case 2
	  	hy_how="<font color=green>正常</font>"
		 hy_do=" <a class=""btn btn-info"" href=""admin_post_check.asp?mydo=masking&modid="& topic_id &""" onClick=""return makesure('是否屏蔽该帖子?\n屏蔽后该帖子主题无法查看，但是回复内容还可以被他人查看');"" title=屏蔽>屏蔽</a>" 
	  case 3
	  	hy_how="<font color=blue>屏蔽中</font>"	  
		hy_do="<a class=""btn btn-success"" href=""admin_post_check.asp?mydo=unmasking&modid="& topic_id &""" onClick=""return makesure('是否解除屏蔽?');"" title=解除屏蔽>恢复</a>" 
  end select
  hy_do=hy_do&" <a href=""admin_post_check.asp?mydo=del_topic&modid="& topic_id &""" onClick=""return makesure('是否删除该主题?\n将会连该主题、回复一起删除');"" class=""btn btn-danger"" title=删除主题>删主题</a>" 
  %>
