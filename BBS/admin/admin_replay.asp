...
<% if rs.eof then%>
  ...
  select case topic_state
	  case 1
		...
		hy_do=hy_do&" <a class=""btn btn-success"" href=""admin_replay_check.asp?mydo=checked&modid="& replay_id &""" onClick=""return makesure('是否审核该帖子?');"" title=审核>审核</a>"				 
	  case 2
	  	hy_how="<font color=green>正常</font>"
		 hy_do=" <a class=""btn btn-info"" href=""admin_replay_check.asp?mydo=masking&modid="& replay_id &""" onClick=""return makesure('是否屏蔽该帖子?\n屏蔽后该帖子主题无法查看，但是回复内容还可以被他人查看');"" title=屏蔽>屏蔽</a>" 
	  case 3
	  	hy_how="<font color=blue>屏蔽中</font>"	  
		hy_do="<a class=""btn btn-success"" href=""admin_replay_check.asp?mydo=unmasking&modid="& replay_id &""" onClick=""return makesure('是否解除屏蔽?');"" title=解除屏蔽>恢复</a>" 
  end select
  hy_do=hy_do&" <a href=""admin_replay_check.asp?mydo=del_replay&modid="& replay_id &""" onClick=""return makesure('是否删除该回复?\n将会删除回复，不影响主题');"" class=""btn btn-danger"" title=删除回复>删回复</a>" 
  %>
  ...
  <thead>
  	<tr>
        <th colspan="10" class="text-center">
            ...
            <ul class="pagination">
            	<%=bbs_page_no(page_no,pagecount,"see_user_id="& see_user_id &"&key_word="& key_word &"&dtfrom="& dtfrom &"&dtto="& dtto &"&see_type="& see_type &"")%>
            </ul>
        </th>
    </tr>
  </thead>
