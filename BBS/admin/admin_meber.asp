...
<% if rs.eof then%>
  ...
  select case user_state
	  case 1
		...
		hy_do=hy_do&" <a href=""hyedit_gl.asp?mydo=mod&modid="& user_id &""" title=修改会员资料 class=""btn btn-warning"">修改</a>"
		hy_do=hy_do&" <a class=""btn btn-success"" href=""admin_meber_check.asp?mydo=gag&modid="& user_id &""" onClick=""return makesure('是否禁止该会员发言?\n禁言后该会员仍然可以登录、浏览帖子等，但无法发表帖子');"" title=禁言会员>禁言</a>"
		hy_do=hy_do&" <a class=""btn btn-info"" href=""admin_meber_check.asp?mydo=lock&modid="& user_id &""" onClick=""return makesure('是否锁定该会员发言?\n锁定后该会员无法登录、浏览、发表帖子');"" title=锁定会员>锁定</a>" 		 
	  case 2
	  	hy_how="<font color=red>已禁言</font>"
		 hy_do="<a class=""btn btn-success"" href=""admin_meber_check.asp?mydo=ungag&modid="& user_id &""" onClick=""return makesure('是否解除禁言该会员?');"" title=解除禁言>解除禁言</a>" 
	  case 3
	  	hy_how="<font color=blue>锁定中</font>"	  
		hy_do="<a class=""btn btn-success"" href=""admin_meber_check.asp?mydo=unlock&modid="& user_id &""" onClick=""return makesure('是否解除锁定该会员?');"" title=解锁会员>解除锁定</a>" 
  end select
  hy_do=hy_do&" <a href=""admin_meber_check.asp?mydo=del_user_post&modid="& user_id &""" onClick=""return makesure('是否删除该会员所发表的所有帖子?\n将会连该会员的主题、回复一起删除');"" class=""btn btn-danger"" title=删除帖子>删贴</a> <a href=""admin_meber_check.asp?mydo=del_user&modid="& user_id &""" onClick=""return makesure('是否删除该会员?\n将会连该会员的主题、回复一起删除');"" class=""btn btn-danger"" title=删除会员>删人</a>" 
  %>
  ...
  <thead>
  	<tr>
        <th colspan="10" class="text-center">
            ...
            <ul class="pagination">
            	<%=bbs_page_no(page_no,pagecount,"key_word="& key_word &"&dtfrom="& dtfrom &"&dtto="& dtto &"&see_type="& see_type &"")%>
            </ul>
        </th>
    </tr>
  </thead>
