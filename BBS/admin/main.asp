...
<div class="top_menu_1_div">
    <div class="top_menu_1">
    	<ul>
            ...
            <li onClick="dis_menu(2)" onMouseOver="dis_menu(2)"><a href="javascript:void(0);" id="focus_this_menu_2">帖子管理</a></li>
...
<div class="top_menu_2_div">	
    <div class="top_menu_2">
    	...
    	<ul id="menu_2">
        	...
        	<li><a href="admin_post.asp?see_type=2" target="right"><img src="../inc/wdiii/ico/PBL201131_v.png"><br>主题管理</a></li>
